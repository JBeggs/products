#!/usr/bin/env python3
"""
Gimme Online (gimmeonline.co.za) — session-based browse and save.
...
SUPPLIER_SLUG = "gimmeonline"
HOST = "gimmeonline.co.za"
BASE_URL = "https://gimmeonline.co.za/"
SOURCE_PRICE_KEY = "gimmeonline_price"
TAGS = ["gimmeonline", "gimme-online"]
SESSION_FILE = Path(__file__).parent / "gimmeonline_session.json"

URLS_HEADER = f"""# Gimme Online — product URLs (one per line), or browse and Save in the UI.
# Store: {BASE_URL}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scrape Gimme Online (browse and save)")
