#!/usr/bin/env python3
"""
Young's Industrial (youngsindustrial.co.za) — session-based browse and save.
...
SUPPLIER_SLUG = "youngsindustrial"
HOST = "youngsindustrial.co.za"
BASE_URL = "https://youngsindustrial.co.za/"
SOURCE_PRICE_KEY = "youngsindustrial_price"
TAGS = ["youngsindustrial", "youngs-industrial"]
SESSION_FILE = Path(__file__).parent / "youngsindustrial_session.json"

URLS_HEADER = f"""# Young's Industrial — product URLs (one per line), or browse and Save in the UI.
# Store: {BASE_URL}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scrape Young's Industrial (browse and save)")
