#!/usr/bin/env python3
"""
Communica South Africa (communica.co.za) — session-based browse and save.
"""
...
SUPPLIER_SLUG = "communica"
HOST = "communica.co.za"
BASE_URL = "https://www.communica.co.za/"
SOURCE_PRICE_KEY = "communica_price"
TAGS = ["communica", "electronics"]
SESSION_FILE = Path(__file__).parent / "communica_session.json"

URLS_HEADER = f"""# Communica — add product page URLs here (one per line), or browse and Save in the UI.
# Store: {BASE_URL}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scrape Communica South Africa (browse and save)")
