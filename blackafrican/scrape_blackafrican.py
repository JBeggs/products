#!/usr/bin/env python3
"""
Black African (blackafrican.co.za) — session-based browse and save scraper.
...
SUPPLIER_SLUG = "blackafrican"
HOST = "blackafrican.co.za"
BASE_URL = "https://www.blackafrican.co.za/"
SOURCE_PRICE_KEY = "blackafrican_price"
TAGS = ["blackafrican"]
SESSION_FILE = Path(__file__).parent / "blackafrican_session.json"

URLS_HEADER = f"""# Black African — product URLs (one per line), or browse and Save in the UI.
# Store: {BASE_URL}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scrape Black African (browse and save)")
