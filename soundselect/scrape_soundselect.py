#!/usr/bin/env python3
"""
Sound Select (soundselect.co.za) — session-based browse and save.
...
SUPPLIER_SLUG = "soundselect"
HOST = "soundselect.co.za"
BASE_URL = "https://soundselect.co.za/"
SOURCE_PRICE_KEY = "soundselect_price"
TAGS = ["soundselect", "sound-select"]
SESSION_FILE = Path(__file__).parent / "soundselect_session.json"

URLS_HEADER = f"""# Sound Select — product URLs (one per line), or browse and Save in the UI.
# Store: {BASE_URL}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scrape Sound Select (browse and save)")
