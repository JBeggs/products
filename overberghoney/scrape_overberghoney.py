#!/usr/bin/env python3
"""
Overberg Honey Co (overberghoney.co.za) — session-based browse and save.
...
SUPPLIER_SLUG = "overberghoney"
HOST = "overberghoney.co.za"
BASE_URL = "https://www.overberghoney.co.za/"
SOURCE_PRICE_KEY = "overberghoney_price"
TAGS = ["overberghoney", "overberg-honey"]
SESSION_FILE = Path(__file__).parent / "overberghoney_session.json"

URLS_HEADER = f"""# Overberg Honey Co — product URLs (one per line), or browse and Save in the UI.
# Store: {BASE_URL}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scrape Overberg Honey Co (browse and save)")
