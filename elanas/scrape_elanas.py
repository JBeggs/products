#!/usr/bin/env python3
"""
Elana's (elanas.co.za) — session-based browse and save.
...
SUPPLIER_SLUG = "elanas"
HOST = "elanas.co.za"
BASE_URL = "https://elanas.co.za/"
SOURCE_PRICE_KEY = "elanas_price"
TAGS = ["elanas", "elanas-robertson"]
SESSION_FILE = Path(__file__).parent / "elanas_session.json"

URLS_HEADER = f"""# Elana's — product URLs (one per line), or browse and Save in the UI.
# Store: {BASE_URL}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scrape Elana's (browse and save)")
