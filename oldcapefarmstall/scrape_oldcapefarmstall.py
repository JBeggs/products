#!/usr/bin/env python3
"""
Old Cape Farm Stall (oldcapefarmstall.co.za) — session-based browse and save.
...
SUPPLIER_SLUG = "oldcapefarmstall"
HOST = "oldcapefarmstall.co.za"
BASE_URL = "https://oldcapefarmstall.co.za/"
SOURCE_PRICE_KEY = "oldcapefarmstall_price"
TAGS = ["oldcapefarmstall", "old-cape-farm-stall"]
SESSION_FILE = Path(__file__).parent / "oldcapefarmstall_session.json"

URLS_HEADER = f"""# Old Cape Farm Stall — product URLs (one per line), or browse and Save in the UI.
# Store: {BASE_URL}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scrape Old Cape Farm Stall (browse and save)")
