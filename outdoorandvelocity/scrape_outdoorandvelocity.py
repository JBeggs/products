#!/usr/bin/env python3
"""
Outdoor and Velocity (outdoorandvelocity.co.za) — session-based browse and save.

WooCommerce-style store; uses generic PDP extraction + generic session UI.
"""
...
SUPPLIER_SLUG = "outdoorandvelocity"
HOST = "outdoorandvelocity.co.za"
BASE_URL = "https://outdoorandvelocity.co.za/"
SOURCE_PRICE_KEY = "outdoorandvelocity_price"
TAGS = ["outdoorandvelocity", "outdoor-and-velocity"]
SESSION_FILE = Path(__file__).parent / "outdoorandvelocity_session.json"

PRICE_CHECK_NAV_TIMEOUT_MS = 120_000
PRICE_CHECK_CONTENT_TIMEOUT_MS = 90_000

URLS_HEADER = f"""# Outdoor and Velocity — product URLs (one per line), or browse and Save in the UI.
# Store: {BASE_URL}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scrape Outdoor and Velocity (browse and save)")
