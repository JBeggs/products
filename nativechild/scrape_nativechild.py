#!/usr/bin/env python3
"""
Nativechild (nativechild.co) — session-based browse and save scraper.
...
SUPPLIER_SLUG = "nativechild"
HOST = "nativechild.co"
BASE_URL = "https://www.nativechild.co/"
SOURCE_PRICE_KEY = "nativechild_price"
TAGS = ["nativechild", "haircare", "bodycare"]
SESSION_FILE = Path(__file__).parent / "nativechild_session.json"

URLS_HEADER = f"""# Nativechild — product URLs (one per line), or browse and Save in the UI.
# Store: {BASE_URL}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scrape Nativechild (browse and save)")
