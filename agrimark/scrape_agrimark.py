#!/usr/bin/env python3
"""
Agrimark (agrimark.co.za) — session-based browse and save.
...
SUPPLIER_SLUG = "agrimark"
HOST = "agrimark.co.za"
BASE_URL = "https://www.agrimark.co.za/"
SOURCE_PRICE_KEY = "agrimark_price"
TAGS = ["agrimark", "agrimark-co-za"]
SESSION_FILE = Path(__file__).parent / "agrimark_session.json"

URLS_HEADER = f"""# Agrimark — product URLs (one per line), or browse and Save in the UI.
# Store: {BASE_URL}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scrape Agrimark (browse and save)")
