#!/usr/bin/env python3
"""
BulkSeed.co.za — session-based browse and save.

Generic PDP extraction; tweak dom_product_extract later if their markup differs.
Site: https://www.bulkseed.co.za/
"""
...
SUPPLIER_SLUG = "bulkseed"
HOST = "bulkseed.co.za"
BASE_URL = "https://www.bulkseed.co.za/"
SOURCE_PRICE_KEY = "bulkseed_price"
TAGS = ["bulkseed", "bulkseed-co-za"]
SESSION_FILE = Path(__file__).parent / "bulkseed_session.json"

URLS_HEADER = f"""# BulkSeed.co.za — product URLs (one per line), or browse and Save in the UI.
# Store: {BASE_URL}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scrape BulkSeed.co.za (browse and save)")
