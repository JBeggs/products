#!/usr/bin/env python3
"""
Britelighting (britelighting.co.za) — session-based browse and save.
...
SUPPLIER_SLUG = "britelighting"
HOST = "britelighting.co.za"
BASE_URL = "https://britelighting.co.za/"
SOURCE_PRICE_KEY = "britelighting_price"
TAGS = ["britelighting", "britelighting-co-za"]
SESSION_FILE = Path(__file__).parent / "britelighting_session.json"

URLS_HEADER = f"""# Britelighting — product URLs (one per line), or browse and Save in the UI.
# Store: {BASE_URL}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scrape Britelighting (browse and save)")
