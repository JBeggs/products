#!/usr/bin/env python3
"""
AHM Online (www.ahm.co.za) — session-based browse and save.

Shopify storefront; PDPs under /products/... — uses shared JSON-LD / OG extraction.
Enable SCRAPER_DEBUG=1 for debug_capture/ (HTML, screenshot, field JSON).
"""
...
SUPPLIER_SLUG = "ahm"
HOST = "ahm.co.za"
BASE_URL = "https://www.ahm.co.za/"
SOURCE_PRICE_KEY = "ahm_price"
TAGS = ["ahm", "ahm-online"]
SESSION_FILE = Path(__file__).parent / "ahm_session.json"

URLS_HEADER = f"""# AHM Online — product URLs (one per line), or browse and Save in the UI.
# Store: {BASE_URL}
# Example PDP: https://www.ahm.co.za/products/your-product-handle
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scrape AHM Online (browse and save)")
