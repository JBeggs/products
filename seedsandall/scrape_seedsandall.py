#!/usr/bin/env python3
"""
Seeds and All (seedsandall.co.za) — session-based browse and save.

Generic PDP extraction; adjust later if their HTML/JSON-LD differs.
"""
...
SUPPLIER_SLUG = "seedsandall"
HOST = "seedsandall.co.za"
BASE_URL = "https://www.seedsandall.co.za/"
SOURCE_PRICE_KEY = "seedsandall_price"
TAGS = ["seedsandall", "seedsandall-co-za"]
SESSION_FILE = Path(__file__).parent / "seedsandall_session.json"

URLS_HEADER = f"""# Seeds and All — product URLs (one per line), or browse and Save in the UI.
# Store: {BASE_URL}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scrape Seeds and All (browse and save)")
