#!/usr/bin/env python3
"""
Seeds for Africa (seedsforafrica.co.za) — session-based browse and save.
...
SUPPLIER_SLUG = "seedsforafrica"
HOST = "seedsforafrica.co.za"
BASE_URL = "https://www.seedsforafrica.co.za/"
SOURCE_PRICE_KEY = "seedsforafrica_price"
TAGS = ["seedsforafrica", "seeds-for-africa"]
SESSION_FILE = Path(__file__).parent / "seedsforafrica_session.json"

URLS_HEADER = f"""# Seeds for Africa — product URLs (one per line), or browse and Save in the UI.
# Store: {BASE_URL}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scrape Seeds for Africa (browse and save)")
