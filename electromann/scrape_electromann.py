#!/usr/bin/env python3
"""
Electromann SA (electromannsa.co.za) — session-based browse and save.
...
SUPPLIER_SLUG = "electromann"
HOST = "electromannsa.co.za"
BASE_URL = "https://electromannsa.co.za/"
SOURCE_PRICE_KEY = "electromann_price"
TAGS = ["electromann", "electromannsa"]
SESSION_FILE = Path(__file__).parent / "electromann_session.json"

URLS_HEADER = f"""# Electromann SA — add product page URLs here (one per line), or browse and Save in the UI.
# Store: {BASE_URL}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scrape Electromann SA (browse and save)")
