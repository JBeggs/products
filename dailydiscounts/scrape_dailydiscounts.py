#!/usr/bin/env python3
"""
Daily Discounts (dailydiscounts.co.za) — session-based browse and save.
...
SUPPLIER_SLUG = "dailydiscounts"
HOST = "dailydiscounts.co.za"
BASE_URL = "https://dailydiscounts.co.za/"
SOURCE_PRICE_KEY = "dailydiscounts_price"
TAGS = ["dailydiscounts", "daily-discounts"]
SESSION_FILE = Path(__file__).parent / "dailydiscounts_session.json"

URLS_HEADER = f"""# Daily Discounts — product URLs (one per line), or browse and Save in the UI.
# Store: {BASE_URL}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scrape Daily Discounts (browse and save)")
